...
export const DATA_SEMONS = [
  ...
  },
  {
    ...
    location: 'Kinshasa, RDC',
    src:
      'https://player.vimeo.com/video/291639712?color=f5f8f9&title=0&byline=0&portrait=0',
    screen: 'none',
    isDefault: false,
    islocal: true,
    isInvited: false
  },
  {
    ...
    location: 'Kinshasa, RDC',
    src:
      'https://player.vimeo.com/video/291474042?color=f5f8f9&title=0&byline=0&portrait=0',
    screen: 'none',
    isDefault: false,
    islocal: false,
    isInvited: true
  },
  {
    ...
    location: 'Kinshasa, RDC',
    src:
      'https://player.vimeo.com/video/290988849?color=f5f8f9&title=0&byline=0&portrait=0',
    screen: 'none',
    isDefault: true,
    islocal: false,
    isInvited: false
  },
  {
    ...
    src:
      'https://player.vimeo.com/video/293221804?color=f5f8f9&title=0&byline=0&portrait=0',
    screen: 'none',
    isDefault: true,
    islocal: false,
    isInvited: false
  },
  {
    ...
    location: 'Kinshasa, RDC',
    src:
      'https://player.vimeo.com/video/280806870?color=f9f9f9&title=0&byline=0&portrait=0',
    screen: 'none',
    isDefault: true,
    islocal: false,
    isInvited: false
